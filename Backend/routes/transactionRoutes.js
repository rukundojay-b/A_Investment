...
//     // Create deposit request using user model method
...
//     // Create withdrawal request using user model method
...
//     // Calculate totals
//     const totals = {
//       deposits: transactions.filter(t => t.type === 'deposit').reduce((sum, t) => sum + (t.amount || 0), 0),
//       withdrawals: transactions.filter(t => t.type === 'withdraw').reduce((sum, t) => sum + (t.amount || 0), 0),
//       investments: transactions.filter(t => t.type === 'investment').reduce((sum, t) => sum + (t.amount || 0), 0),
//       earnings: transactions.filter(t => t.type === 'earning').reduce((sum, t) => sum + (t.amount || 0), 0)
//     };
