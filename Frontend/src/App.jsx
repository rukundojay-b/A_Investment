...
const ProtectedAdminRoute = ({ children, darkMode }) => {
    ...
    return (
      <div className={`min-h-screen flex items-center justify-center ${darkMode ? 'bg-gray-900' : 'bg-gray-100'}`}>
        <div className="text-center">
          ...
          <p className={`mt-4 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Verifying admin access...</p>
        </div>
      </div>
    );
  }
    ...
    <Router>
      <Routes>
        ...
        <Route
          ...
          element={
            <ProtectedAdminRoute darkMode={darkMode}>
              <AdminDashboard
                darkMode={darkMode}
                setDarkMode={setDarkMode}
              />
