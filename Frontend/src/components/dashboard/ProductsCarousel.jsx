...
//   // Set launch date and lock status
//   useEffect(() => {
//     // Set your actual launch date here (change this to your real launch date)
//     const launchDate = new Date('2024-03-01'); // Set this to your actual launch date
//     const currentDate = new Date();
//     const daysSinceLaunch = Math.floor((currentDate - launchDate) / (1000 * 60 * 60 * 24));
    
//     console.log('📅 Days since launch:', daysSinceLaunch);
    
//     // Products are locked for first 5 days after launch
//     if (daysSinceLaunch < 5) {
//       const remaining = 5 - daysSinceLaunch;
//       const unlockDate = new Date(launchDate);
//       unlockDate.setDate(launchDate.getDate() + 5);
      
//       setLockInfo({
//         isLocked: true,
//         daysRemaining: remaining,
//         lockEndDate: unlockDate
//       });
//       console.log('🔒 Products locked for', remaining, 'more days');
//     } else {
//       setLockInfo({
//         isLocked: false,
//         daysRemaining: 0,
...
//           // Lock ONLY the last two products if within 5 days of launch
//           const isLastTwoProducts = index >= totalProducts - 2;
//           const shouldLock = lockInfo.isLocked && isLastTwoProducts;
...
//         console.log('✅ Mapped Products with lock status:', mappedProducts.map(p => ({
//           name: p.name,
//           isLocked: p.isLocked
//         })));
...
//     if (product.isLocked) {
//       showToast(
//         `⏳ This premium product is currently locked. It will be available in ${lockInfo.daysRemaining} day${lockInfo.daysRemaining > 1 ? 's' : ''}. Stay tuned!`,
//         'error'
//       );
//       return;
//     }

//     // If product is unlocked, proceed with normal purchase flow
...
//       showToast(
//         `Insufficient balance. You need ${neededAmount} FRW more to purchase ${product.name}.`,
//         'error'
//       );
//       return;
//     }
...
//       {/* Lock Banner - Show when products are locked */}
//       {lockInfo.isLocked && (
//         <div className={`mb-6 p-4 rounded-lg ${darkMode ? 'bg-yellow-900/20 border border-yellow-700/30' : 'bg-yellow-50 border border-yellow-200'}`}>
//           <div className="flex items-center justify-center space-x-2">
//             <FaLock className="text-yellow-500 text-xl" />
//             <p className="text-sm font-medium">
//               🚀 Premium Products Launching Soon! The last 2 products are currently locked.
//             </p>
//           </div>
//           <p className="text-center text-sm mt-2">
//             They will be available in <span className="font-bold text-yellow-500">{lockInfo.daysRemaining} day{lockInfo.daysRemaining > 1 ? 's' : ''}</span>. Stay tuned!
//           </p>
//         </div>
//       )}
...
//                       <div 
//                         key={product._id} 
//                         className={`relative rounded-2xl p-4 md:p-6 border-2 ${classes.bg} ${classes.border} transition-all hover:scale-[1.02] hover:shadow-xl`}
//                       >
//                         {/* Lock Overlay - Show only for locked products */}
//                         {product.isLocked && (
//                           <div className="absolute inset-0 bg-black/60 rounded-2xl flex items-center justify-center backdrop-blur-sm z-10">
//                             <div className="text-center p-4">
//                               <FaLock className="text-white text-4xl mx-auto mb-3" />
//                               <p className="text-white text-sm font-medium mb-2">
//                                 🔒 Premium Product
//                               </p>
//                               <p className="text-white/90 text-xs max-w-[200px] mx-auto">
//                                 Available in {lockInfo.daysRemaining} day{lockInfo.daysRemaining > 1 ? 's' : ''}
//                               </p>
//                             </div>
//                           </div>
//                         )}
...
//                           disabled={purchaseLoading[product._id] || product.isLocked}
